        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 pad-r">
                <div id="featured-slider" class="owl-carousel owl-theme featured-slider">
                    <div class="item" style="background-image:url({{asset('newstime/images/news/lifestyle/health5.jpg')}})">
                    ...
                    <div class="item" style="background-image:url({{asset('newstime/images/news/tech/gadget2.jpg')}})">
                        <div class="featured-post">
                             <div class="post-content">
                    ...
                    <div class="item" style="background-image:url({{asset('newstime/images/news/lifestyle/travel5.jpg')}})">
                        <div class="featured-post">
                             <div class="post-content">
            ...
            <div class="col-lg-6 col-md-12 pad-l">
                <div class="row">
                    <div class="col-md-6 pad-r-small">
                        <div class="post-overaly-style contentTop fourNewsboxTop clearfix">
                            <div class="post-thumb">
                                <a href="#"><img class="img-fluid" src="{{asset('newstime/images/news/tech/gadget2.jpg')}}" alt="" /></a>
                            </div>
                            <div class="post-content">
                    ...
                    <div class="col-md-6 pad-l-small">
                        <div class="post-overaly-style contentTop fourNewsboxTop clearfix">
                            <div class="post-thumb">
                                <a href="#"><img class="img-fluid" src="{{asset('newstime/images/news/tech/game1.jpg')}}" alt="" /></a>
                            </div>
                            <div class="post-content">
                    ...
                    <div class="col-md-6 pad-r-small">
                        <div class="post-overaly-style contentTop fourNewsbox clearfix">
                            <div class="post-thumb">
                                <a href="#"><img class="img-fluid" src="{{asset('newstime/images/news/lifestyle/travel2.jpg')}}" alt="" /></a>
                            </div>
                            <div class="post-content">
                                 <a class="post-cat" href="#">Travel</a>
                                 <h2 class="post-title title-medium">
                    ...
                    <div class="col-md-6 pad-l-small">
                        <div class="post-overaly-style contentTop fourNewsbox clearfix">
                            <div class="post-thumb">
                                <a href="#"><img class="img-fluid" src="{{asset('newstime/images/news/lifestyle/health1.jpg')}}" alt="" /></a>
                            </div>
                            <div class="post-content">
                                 <a class="post-cat" href="#">Health</a>
                                 <h2 class="post-title title-medium">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sidebar sidebar-right">
                    ...
                    <div class="widget text-center">
                        <img class="banner img-fluid" src="images/banner-ads/ad-sidebar2.png" alt="" />
                    </div><!-- Sidebar Ad end -->
...
<section class="ad-content-area text-center no-padding">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <img class="img-fluid" src="images/banner-ads/ad-top-header.png" alt="" />
            </div><!-- Col end -->
        </div><!-- Row end -->
    </div><!-- Container end -->
