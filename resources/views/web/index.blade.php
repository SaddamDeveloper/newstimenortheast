            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 pad-r">
                    <div id="featured-slider" class="owl-carousel owl-theme featured-slider">
                        <div class="item" style="background-image:url({{asset('web/images/news/lifestyle/health5.jpg')}})">
                        ...
                        <div class="item" style="background-image:url({{asset('web/images/news/tech/gadget2.jpg')}})">
                            <div class="featured-post">
                                 <div class="post-content">
                        ...
                        <div class="item" style="background-image:url({{asset('web/images/news/lifestyle/travel5.jpg')}})">
                            <div class="featured-post">
                                 <div class="post-content">
                ...
                <div class="col-lg-6 col-md-12 pad-l">
                    <div class="row">
                        <div class="col-md-6 pad-r-small">
                            <div class="post-overaly-style contentTop fourNewsboxTop clearfix">
                                <div class="post-thumb">
                                    <a href="#"><img class="img-fluid" src="{{asset('web/images/news/tech/gadget2.jpg')}}" alt="" /></a>
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-md-6 pad-l-small">
                            <div class="post-overaly-style contentTop fourNewsboxTop clearfix">
                                <div class="post-thumb">
                                    <a href="#"><img class="img-fluid" src="{{asset('web/images/news/tech/game1.jpg')}}" alt="" /></a>
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-md-6 pad-r-small">
                            <div class="post-overaly-style contentTop fourNewsbox clearfix">
                                <div class="post-thumb">
                                    <a href="#"><img class="img-fluid" src="{{asset('web/images/news/lifestyle/travel2.jpg')}}" alt="" /></a>
                                </div>
                                <div class="post-content">
                                     <a class="post-cat" href="#">Travel</a>
                                     <h2 class="post-title title-medium">
                        ...
                        <div class="col-md-6 pad-l-small">
                            <div class="post-overaly-style contentTop fourNewsbox clearfix">
                                <div class="post-thumb">
                                    <a href="#"><img class="img-fluid" src="{{asset('web/images/news/lifestyle/health1.jpg')}}" alt="" /></a>
                                </div>
                                <div class="post-content">
                                     <a class="post-cat" href="#">Health</a>
                                     <h2 class="post-title title-medium">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12">
                                                ...
                                                <ul class="list-post">
                                                    ...
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/gadget5.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                    ...
                    <!--- Featured Tab startet -->
                    <div class="featured-tab">
                        <h3 class="block-title"><span>Assam</span></h3>
                                ...
                                <div class="row">
                                      <div class="col-md-6">
                                          <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-fluid" src="{{asset('web/images/news/tech/game1.jpg')}}" alt="" />
                                                    </a>
                                                </div>
                                                <div class="post-content">
                                                     <h2 class="post-title">
                                                ...
                                                <ul class="list-post">
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/game2.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                                                    ...
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/game3.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                                                    ...
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/game4.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                                                    ...
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/game5.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                    ...
                    <div class="featured-tab">
                        <h3 class="block-title"><span>Guwahati</span></h3>

                        <div class="tab-content">
                            <div class="tab-pane active animated fadeInLeft" id="tab_c">
                                ...
                                <div class="row">
                                      <div class="col-md-6">
                                          <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-fluid" src="{{asset('web/images/news/tech/robot1.jpg')}}" alt="" />
                                                    </a>
                                                </div>
                                                <div class="post-content">
                                                     <h2 class="post-title">
                                                ...
                                                <ul class="list-post">
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/robot2.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                                                    ...
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/robot3.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                                                    ...
                                                    <li class="clearfix">
                                                        <div class="post-block-style post-float clearfix">
                                                            <div class="post-thumb">
                                                                <a href="#">
                                                                    <img class="img-fluid" src="{{asset('web/images/news/tech/robot4.jpg')}}" alt="" />
                                                                </a>
                                                            </div><!-- Post thumb end -->
                        ...
                        <div class="row">
                            <div class="col-md-6 homecol2">
                                ...
                                <div class="post-overaly-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="{{asset('web/images/news/lifestyle/travel1.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    ...
                                    <ul class="list-post">
                                        ...
                                        <li class="clearfix">
                                            <div class="post-block-style post-float clearfix">
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-fluid" src="{{asset('web/images/news/lifestyle/food2.jpg')}}" alt="" />
                                                    </a>
                                                </div><!-- Post thumb end -->
                                        ...
                                        <li class="clearfix">
                                            <div class="post-block-style post-float clearfix">
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-fluid" src="{{asset('web/images/news/lifestyle/architecture1.jpg')}}" alt="" />
                                                    </a>
                                                </div><!-- Post thumb end -->
                            ...
                            <ul class="list-post">
                                ...
                                <li class="clearfix">
                                    <div class="post-block-style post-float clearfix">
                                        <div class="post-thumb">
                                            <a href="#">
                                                <img class="img-fluid" src="{{asset('web/images/news/lifestyle/travel3.jpg')}}" alt="" />
                                            </a>
                                        </div><!-- Post thumb end -->
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="more-news block">
                        <h3 class="block-title"><span>Buisness</span></h3>
